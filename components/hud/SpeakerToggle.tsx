...
export default function SpeakerToggle() {
  ...
  return (
    <button
      ...
      className={[
        'pointer-events-auto fixed right-[470px] top-5 z-30 flex h-9 w-9 items-center justify-center rounded-sm border bg-black/40 font-mono text-[14px] backdrop-blur-xl transition-colors',
        muted
