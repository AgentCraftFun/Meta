...
/**
 * Per-page metadata for /siteNEW. Re-exported from page.tsx. metadataBase makes
 * the relative OG/canonical URLs absolute; theme-color #05080F is set globally
 * in app/layout.tsx's viewport export.
 */
export const metadata: Metadata = {
  metadataBase: new URL('https://metamap.space'),
  title: TITLE,
  description: DESCRIPTION,
  alternates: { canonical: '/siteNEW' },
  openGraph: {
    type: 'website',
    siteName: 'MetaMap',
    title: TITLE,
